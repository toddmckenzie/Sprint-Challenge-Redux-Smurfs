...
actions are the functions that tell the reducer to do something.  the store is the centralized place for the state of the app to stay and render to the ui.  Reducers take requests from actions and then send to store.

- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?

component state is state that just lives in the component and does not live in the application store for some reason.  there are states that the application doesn't need to store and can be left in the component.

- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?


redux-thunk is middleware.  allows us to use asynchronous programming.  Allows our acitons creator to become async.
## Project Set Up
